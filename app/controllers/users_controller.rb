class UsersController < ApplicationController
  ...
  def show
    if params[:mp3_album_id]
      ...
      flash[:alert] = "Your link: <a href=#{link}>Click here.</a> Your link will be valid for the next 20 minutes. Thank you for using Oho Recordings".html_safe
      ...
      flash[:alert] = "Your link: <a href=#{link}>Click here.</a> Right click and choose 'Save As' to download. Your link will be valid for the next 20 minutes. Thank you for using Oho Recordings".html_safe
